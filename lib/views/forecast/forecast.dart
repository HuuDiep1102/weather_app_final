...
import 'package:weather_app/views/forecast/daily.dart';
import 'package:weather_app/views/forecast/hourly.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        color: bgColor,
        borderRadius: BorderRadius.circular(isWindowOpen ? 0 : 0),
